...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-surface-container-lowest flex flex-col justify-center px-6 font-body">
      <motion.div 
      ...
      >
        <div className="text-center space-y-2">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-3xl bg-primary-container text-primary mb-2">
            <PawPrint size={32} />
          </div>
          <h1 className="text-3xl font-black font-headline">欢迎回来</h1>
          <p className="text-secondary font-medium">登录以继续寻找您的毛孩子</p>
        </div>
